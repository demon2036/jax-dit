...
def test_convert(args):
    ...
    dataloader = create_dataloaders('gs://shadow-center-2b/imagenet-generated-100steps/imagenet-generated-100steps_shards-00781.tar',valid_batch_size=per_process_generate_data)
