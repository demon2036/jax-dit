...
def train():
    ...
    model = DiT_B_2(out_channels=c, labels=10, image_size=h)
    ...
    def test(state, x, y):
        ...
        def loss_fn(params, t):
            terms = state.apply_fn({'params': params}, x, t, {'y': y, 'train': True}, key=rngs['noise_key'], rngs=rngs)
